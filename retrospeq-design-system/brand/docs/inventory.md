...
| 1.19 | `/dashboard` | Field-introduction offer (after month one, framed by a finding) | 08 §5.5, §8 | new | ● (built to mockup, real eligibility/decline/cooldown; the default-strategy reachability gap this row previously caveated is closed 2026-09-15 — the default strategy's own derived fields now let the edge engine compute a real finding for it, live-proven end-to-end, `docs/infra-gaps.md`) |
